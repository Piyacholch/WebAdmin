  ...
  <div class="Box">
    ...
    <div class="search mt-0">
      ...
      <div class="col col-flex d-flex justify-content-end mt-5">
        <a href="/insertactivity" class="a-insert">
    ...
    <div class="block">
      <div class="row block-item block-bm" v-for="item in filtersearch" :key="item">
        ...
        <div class="col-3 button-1">
          <button type="button button-1" class="btn btn-primary edit" @click="
            $router.push(
        ...
        <div class="col-3 button-res">
          <button type="button" class="btn btn-primary edit edit-res" @click="
            $router.push(
              `/updateActivity/${item.id}`
            )
          ">
          ...
          <button type="button" class="btn btn-danger delete delete-res" data-bs-toggle="modal"
            data-bs-target="#exampleModal" @click="confirmdelete(item.id)">
        ...
        <div class="modal-dialog modal-dialog-centered modal-md">
          <div class="modal-content border border-5">
            ...
            <div class="modal-footer border-0 mt-3">
              <div class="col">
                <button type="button" class="btn btn-warning" data-bs-dismiss="modal" @click="deleteactivity(id)">
                  ยืนยัน
                </button>
              </div>
              <div class="col">
...
export default {
  ...
  methods: {
    getactivity() {
      axios.get(process.env.VUE_APP_BACKEND_BASE_URL + "/activity", { params: { sortBy: this.sortBy, first: this.first } }).then((response) => {
