  ...
  props: {
    ...
    menuItems: {
      ...
      default: () => [
        ...
        {
          link: "replymessage",
          name: "แก้ไขข้อความตอบกลับ",
          tooltip: "แก้ไขข้อความตอบกลับ",
        ...
        {
          link: "activity",
          name: "แก้ไขกิจกรรมที่ชอบ",
          tooltip: "แก้ไขกิจกรรมที่ชอบ",
          icon: "bx-heart",
          // icon: 'bx-chat',
        },
        {
          link: "assistance",
          name: "แก้ไขแหล่งช่วยเหลือ",
          tooltip: "แก้ไขแหล่งช่วยเหลือ",
          icon: "bx-support",
          // icon: 'bx-chat',
        },
    ...
    profileImg: {
      type: String,
      default: require("@/assets/img/Gler.png"),
    },
    profileName: {
      type: String,
      default: "Gler",
